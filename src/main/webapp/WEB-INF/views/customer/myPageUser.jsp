	...
	<div class="main">
		...
		<div class="content">
			...
			<div class="updateUser">
				<h2>개인 정보 변경</h2>
				<p>
					아이디 : <input type="text" placeholder="기존값">
				</p>
				<p>
					비밀번호 : <input type="password">
				</p>
				<p>
					이름 : <input type="text" placeholder="기존값">
				</p>
				<p>
					전화번호 : <input type="text" placeholder="01000008888">
				</p>
				<p>
					이메일 : <input type="text" placeholder="example@example.com">
				</p>
					...
					<tbody>
						<tr>
							...
							<td><button class="btn deleteBtn"
									onclick="deleteReservation(this)">삭제</button></td>
						</tr>
					</tbody>
				</table>
			</div>
				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td>2024-08-01</td>
							<td><button class="btn deleteBtn"
									onclick="deleteReview(this)">삭제</button></td>
						</tr>
					</tbody>
				</table>
			</div>
			<div class="deleteUser">
				...
				<form id="deleteForm" action="/delete-account" method="post">
					<p>
						비밀번호 : <input type="password" name="deletePassword"
							id="deletePassword">
					</p>
